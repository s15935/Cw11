    ...
    public class ClinicDbContext : DbContext
    {
        ...
        private static void SeedDataToDb(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Doctor>().HasData(
                new Doctor {IdDoctor = 1, FirstName = "Andrii", LastName = "Korolew", Email = "KorolevAndri@gmail.com"},
                new Doctor {IdDoctor = 2, FirstName = "Anastasia", LastName = "Malanuk", Email = "AnastasiaMalanuk@gmail.com"}
            );
            modelBuilder.Entity<Patient>().HasData(
                new Patient {IdPatient = 1, FirstName = "Sofia", LastName = "Gulman", Birthdate = DateTime.Now},
                new Patient {IdPatient = 2, FirstName = "Marcin", LastName = "Hopinski", Birthdate = DateTime.Now}
            );
            modelBuilder.Entity<Medicament>().HasData(
                new Medicament
                    {IdMedicament = 1, Name = "Ibuprofen", Description = "Lekarstwo na gorączkę", Type = "Syrop"},
                new Medicament
                    {IdMedicament = 2, Name = "Węgiel aktywowany", Description = "Węgiel aktywowany", Type = "Tabletka"}
            );
